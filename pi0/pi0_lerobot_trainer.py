...
class PI0LeRobotTrainer(Trainer):
    ...
    def _inner_training_loop(
        ...
        if args.gradient_checkpointing:
            self.model.model.paligemma_with_expert.paligemma.gradient_checkpointing_enable(gradient_checkpointing_kwargs=args.gradient_checkpointing_kwargs)
    ...
    def _maybe_log_save_evaluate(self, tr_loss, model, trial, epoch, ignore_keys_for_eval, all_loss=None):
        ...
        if self.control.should_save:
            ...
            #     save_path = os.path.join(output_dir, "lerobot_style")
    ...
    #     self.model.save_pretrained(save_path)
    #
    #     # super(PI0LeRobotTrainer, self)._save(output_dir, state_dict)

...
path1 = "/media/rl/HDD/data/data/aloha_data/lerobot"
path2 = "/home/jovyan/tzb/lerobot_data/aloha"
...
print("@@"*50)
print(lerobot_home)
LEROBOT_HOME = Path(os.getenv("LEROBOT_HOME", lerobot_home)).expanduser()
...
class LeRobotDatasetMetadata:
    ...
    def save_episode(self, episode_index: int, episode_length: int, task: str, task_index: int,language_dict:dict ) -> None:
...
class LeRobotDataset(torch.utils.data.Dataset):
    ...
    def load_hf_dataset(self) -> datasets.Dataset:
        ...
        cache_dir = "/home/share/temp"
        if not os.path.exists(cache_dir):
            cache_dir = "/media/rl/HDD/data/lerobot/cache_dir"
    ...
    def save_episode(self, task: str, encode_videos: bool = True, episode_data: dict | None = None , language_dict: dict | None = None) -> None:
        """
        ...
        self.meta.save_episode(episode_index, episode_length, task, task_index,language_dict)
